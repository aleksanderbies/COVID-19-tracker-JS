...
//creating the countries list
function countriesListCreator(){
    const number_of_countries = countries.length;
...
countriesListCreator();

//showing-hiding country list
...
change_country_button.addEventListener("click", function(){
    ...
    change_country_button.classList.toggle("hide");
});

close_list_button.addEventListener("click", function(){
    search_country_element.classList.toggle("hide");
    change_country_button.classList.toggle("hide");
    change_country_button.classList.add("fadeIn");
});
